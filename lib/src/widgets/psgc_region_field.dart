...
/// A standalone region dropdown bound to a [PsgcPickerController]. Can be
/// placed anywhere in the widget tree independently of [PsgcProvinceField]
/// and [PsgcCityField], as long as they all share the same [controller].
class PsgcRegionField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) => PsgcDropdownWidget(
        ...
        selection: controller.regionList,
        selectedValue: controller.selectedRegionCode,
        onSelectionChanged: controller.selectRegion,
      ),
    );
  }
}
